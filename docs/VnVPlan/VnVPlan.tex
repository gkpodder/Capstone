...
\textbf{Tools Used:}
\begin{itemize}
\item GitHub Issues and Projects for tracking comments and progress.
\item Review checklists for verifying requirement structure and numbering.
\item Simple scripts to detect missing or duplicate requirement IDs.
\item Revision history documenting updates and approvals.
\end{itemize}
