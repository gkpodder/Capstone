...
\subsubsection{Input and Recognition Requirements (FUNC.R.1–FUNC.R.2)}

\begin{enumerate}

\item{Test FUNC.R.1 - Speech and Text Input Acceptance\\}
...
\item{Test FUNC.R.2 - Speech-to-Text Accuracy (ASR Module)\\}
...
spoken by 10 different speakers with varied accents.
...
\subsubsection{Intent Understanding and Task Execution (FUNC.R.3–FUNC.R.4)}

\begin{enumerate}

\item{Test FUNC.R.3 - Intent Recognition Accuracy\\}
...
\item{Test FUNC.R.4 - Task Planning and Execution Success Rate\\}
...
\item{Test FUNC.R.5 - Response Feedback Timing\\}
...
\item{Test FUNC.R.6 - Contextual Follow-Up Command Interpretation\\}
\textbf{Type:} Functional / Manual Sequence Test

\textbf{Initial State:} System with active short-term conversational memory.

\textbf{Input/Condition:} 20 conversational command sequences (e.g., “Open my calendar” →
“Add meeting at 2 PM” → “Move it to tomorrow”).
...
\item{Test FUNC.R.7 - Interaction and Task Logging Verification\\}
...
\item{Test FUNC.R.8 - High-Level Command Usability\\}
...
\item{Test FUNC.R.9 - Privileged Action Confirmation\\}
