...
\begin{itemize}
  ...
  \item \textbf{Lightweight UI:} A simple AI with options for users click, type, or speak. The UI shows status (listening, thinking, ready), captions for spoken output, and a few big buttons (listen, stop, undo, approve).
